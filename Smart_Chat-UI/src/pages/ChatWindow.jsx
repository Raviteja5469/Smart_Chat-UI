    ...
    <div className="flex-1 flex flex-col bg-white">
      ...
      <div className="p-4 border-b border-gray-200 bg-white">
        ...
        <div className="flex space-x-4 mt-4">
          ...
          <AIActionButton
            icon={Lightbulb}
            label={loadingReplies ? 'Loading...' : 'Smart Replies'}
            onClick={handleGenerateReplies}
            variant={showSmartReplies ? 'primary' : 'secondary'}
          />
        </div>
      </div>
      ...
      {showSmartReplies && (
        <div className="px-4 py-3 border-t border-gray-200 bg-gradient-to-r from-green-50 to-blue-50">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-800">AI Professional Replies</span>
          </div>
          {loadingReplies ? (
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex space-x-3 items-center">
          ...
          <button
            ...
            className={`px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 flex items-center space-x-1 ${loadingEnhance ? 'opacity-60 cursor-not-allowed' : ''}`}
            title="Enhance message"
          >
            <Sparkles className="w-4 h-4" />
            <span className="hidden md:inline text-xs">{loadingEnhance ? 'Enhancing...' : 'Enhance'}</span>
          </button>
          <button
